export const apiGetLiftTable = async (token) => {
    const response = await fetch('/api/liftTables/list', {
        method: 'GET',
        headers: {
...
export const apiCreateLiftTable = async (token, name, technician_id, decription) => {
    ...
    const response = await fetch('/api/liftTables/add', {
        method: 'POST',
        headers: {
            Authorization: `Bearer ${token}`,
...
export const apiUpdateLiftTable = async (token, name, technician_id, id) => {
    ...
    params.append('technician_id', technician_id);
    params.append('id', id);
    const response = await fetch('/api/liftTables/edit', {
        method: 'POST',
        headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/x-www-form-urlencoded',
...
export const apiCreateReceptionVehicle = async (token, id, customer_id, name, license_plate) => {
    ...
    const response = await fetch('/api/liftTables/reception-vehicle', {
        method: 'POST',
        headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/x-www-form-urlencoded',
...
export const apiGetListRepair = async (token) => {
    const response = await fetch('/api/liftTables/repair-list', {
        method: 'GET',
        headers: {
            Authorization: `Bearer ${token}`,
        },
...
export const apiLiftTableReturnVehicle = async (token, id) => {
    const params = new URLSearchParams();
    params.append('id', id);
    const response = await fetch('/api/liftTables/return-vehicle', {
        method: 'POST',
        headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/x-www-form-urlencoded',
